...
export const styles = StyleSheet.create({
  ...
  filterChip: { backgroundColor: '#E5E7EB', justifyContent: "center", borderRadius: 20, paddingHorizontal: MarginHW.PaddingW16, paddingVertical: MarginHW.PaddingH8 },
  ...
  listContent: { paddingBottom: MarginHW.MarginH70 },
  ...
  logoWrap: { borderRadius: 10, backgroundColor: '#F3F4F6', justifyContent: 'center', alignItems: 'center', marginRight: MarginHW.MarginW10 },
