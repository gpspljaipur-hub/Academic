...
export const styles = StyleSheet.create({
  ...
  activeFilterRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: MarginHW.MarginH8, paddingHorizontal: MarginHW.PaddingW5 },
  activeFilterLabel: { color: '#4B5563', fontFamily: fonts.Lexend_Medium, fontSize: FontsSize.size14 },
  clearFilterText: { color: '#0A56B2', fontFamily: fonts.LexendBold, fontSize: FontsSize.size14 },
