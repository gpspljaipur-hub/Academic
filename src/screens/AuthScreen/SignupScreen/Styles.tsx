...
export const styles = StyleSheet.create({
  ...
  label: { color: Colors.textCharcoal, fontFamily: fonts.Lexend_Medium, fontSize: FontsSize.size16, marginTop: MarginHW.MarginH20 },
  inputWrap: { alignItems: 'center', backgroundColor: Colors.screenGray, borderRadius: 14, flexDirection: 'row', height: HWSize.H_Height45, justifyContent: 'space-between', marginTop: MarginHW.MarginH10, paddingHorizontal: MarginHW.PaddingW18 },
  inputText: { color: '#1B1F2A', flex: 1, fontFamily: fonts.Lexend_Regular, fontSize: FontsSize.size16 },
